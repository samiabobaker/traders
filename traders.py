...
from tabs import leaderboard, login, summary, market, locations
import util
...
locations_tab = ttk.Frame(tabs, padding="3 1 6 5")
...
locations.create_locations_tab(locations_tab, login.widgets["trader_token"])
